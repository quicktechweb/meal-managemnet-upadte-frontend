  ...
  return (
    <footer className="bg-white text-sm text-gray-700 pt-10">
      ...
      <div className="max-w-6xl mx-auto px-4 hidden sm:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
        ...
        {/* ALABADAN INFO */}
        <div>
          <h4 className="text-gray-800 font-semibold text-base mb-4">Alabadan</h4>
          <ul className="space-y-2 text-gray-600">
            {[
              "Download App",
              "Brands List",
        ...
        {/* PAYMENT METHODS */}
        <div>
          <h4 className="text-gray-800 font-semibold text-base mb-4">Payment Methods</h4>
        ...
        {/* SHIPPING OPTIONS */}
        <div>
          <h4 className="text-gray-800 font-semibold text-base mb-4">Shipping Options</h4>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <span className="bg-yellow-400 px-2 py-1 rounded text-white text-sm">🚀</span>
              <div>
                <p className="font-semibold">Express Shipping</p>
                <p className="text-xs text-gray-500">Fast & Priority Delivery</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <span className="bg-gray-400 px-2 py-1 rounded text-white text-sm">📦</span>
              <div>
        ...
        <div>
          ...
          <div className="border rounded-md p-3 bg-gray-50 mb-3 shadow-sm">
            ...
            <p className="text-xs text-gray-500">Get instant support in your preferred language</p>
          </div>
          <div className="mb-3">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <img src="https://sellularr.netlify.app/images/appstore.png" alt="Apple Store" className="h-8" />
              <img src="https://sellularr.netlify.app/images/playstore.png" alt="Play Store" className="h-8 w-6" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="sm:hidden max-w-6xl mx-auto px-4 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          {/* Quick Links */}
          <div>
            <h4 className="text-gray-800 font-semibold text-base mb-3">Quick Links</h4>
            <ul className="space-y-2 text-gray-600">
              {[
                "About Us",
                "Contact Us",
          ...
          {/* Alabadan Info */}
          <div>
            <h4 className="text-gray-800 font-semibold text-base mb-3">Alabadan</h4>
            <ul className="space-y-2 text-gray-600">
              {[
                "Download App",
                "Brands List",
          ...
          {/* Payment Methods */}
          <div>
            <h4 className="text-gray-800 font-semibold text-base mb-3">Payment Methods</h4>
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <img src="https://www.paypalobjects.com/webstatic/icon/pp258.png" alt="Paypal" className="w-6 h-6" />
                <span>PayPal</span>
        ...
        <div className="grid grid-cols-1 gap-6">
          {/* Shipping Options */}
          <div>
            <h4 className="text-gray-800 font-semibold text-base mb-3">Shipping Options</h4>
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <span className="bg-yellow-400 px-2 py-1 rounded text-white text-sm">🚀</span>
                <div>
          ...
          {/* Cities Covered */}
          <div>
            <h4 className="text-gray-800 font-semibold text-base mb-3">Cities Covered</h4>
            <ul className="space-y-2 text-gray-600">
              {[
                "Dhaka",
                "Chittagong (Chattogram)",
          ...
          {/* Support */}
          <div>
            <h4 className="text-gray-800 font-semibold text-base mb-3">24/7 Support</h4>
            <div className="border rounded-md p-3 bg-gray-50 mb-3 shadow-sm">
              <p className="font-semibold text-gray-700">📞 Customer Support</p>
              <p className="text-xs text-gray-500">Get instant support in your preferred language</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-10 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-4 md:space-y-0">
        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 space-y-2 sm:space-y-0">
          ...
          <span className="text-gray-600 text-sm">ISO 27001:2022 Certified</span>
        </div>
        <div className="text-gray-500 text-sm">
          © 2025 Alabadan. Designed & Developed by <a href="#" className="text-blue-600 hover:underline">QuickTech IT</a>
        </div>
      </div>

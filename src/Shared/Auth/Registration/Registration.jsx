...
const Registration = () => {
  ...
  return (
    <div className="min-h-screen bg-white p-4 md:p-10 flex items-center justify-center w-full ">
      <div className="flex flex-row-reverse h-[900px] justify-center items-center shadow-2xl rounded-2xl ">
        <div className="relative w-full max-w-xl h-full bg-white   overflow-hidden flex flex-col items-center justify-between py-12 rounded-tr-2xl rounded-br-2xl">
        ...
        {/*  Login Form */}
        <div className="relative w-full max-w-[500px] h-full bg-white overflow-hidden p-8 flex flex-col rounded-tl-2xl rounded-bl-2xl">
          <div className="mt-4">
    ...
    pointer-events-none"
            ...
            <button
              type="submit"
              className="w-full cursor-pointer py-3 bg-black text-white  text-xl rounded-lg shadow-lg transition-all transform active:scale-95"
            >
              Login
            </button>

            <div>
              <div className="mb-2 text-[18px] flex items-center gap-2">
              ...
              <div className="flex gap-2 items-center mt-4">
                <div className="border-t-2 border-gray-300 w-[150px] "></div>
              ...
              <div className="flex flex-wrap gap-3.5 items-center mt-4 justify-center">
                <Link className="p-[15px] border border-[#d1d1d1] rounded-2xl flex items-center justify-center text-4xl text-blue-500 hover:bg-gray-100/40">
                  <FaFacebook />
                </Link>
                <Link className="p-[15px] border border-[#d1d1d1] rounded-2xl flex items-center justify-center text-4xl text-blue-500 hover:bg-gray-100/40">
                  <FcGoogle />
                </Link>
                <Link className="p-[15px] border border-[#d1d1d1] rounded-2xl flex items-center justify-center text-4xl hover:bg-gray-100/40">
                  <FaApple />
                </Link>
                <Link className="p-[15px] border border-[#d1d1d1] rounded-2xl flex items-center justify-center text-4xl text-blue-400 hover:bg-gray-100/40">
                  <FaTwitter />
                </Link>
              </div>
            </div>

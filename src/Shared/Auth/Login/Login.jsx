...
const Login = () => {
  ...
  return (
    <div className="min-h-screen mt-10 bg-white p-4 md:p-10 flex items-center justify-center w-full ">
      <div className="flex flex-row-reverse h-[650px] justify-center items-center shadow-2xl rounded-2xl ">
        ...
        <div className="relative w-full max-w-[500px] h-full bg-white overflow-hidden p-8 flex flex-col rounded-tl-2xl rounded-bl-2xl">
          <div className="mt-4">
            <h2 className="text-5xl font-serif font-bold text-black ">Login</h2>
          </div>

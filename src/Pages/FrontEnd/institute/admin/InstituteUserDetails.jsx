      ...
      <div className="grid grid-cols-1  gap-3">
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-gray-500 uppercase text-xs font-bold">Name</p>
            ...
            <div>
              <p className="text-gray-500 uppercase text-xs font-bold">Year</p>
              <p className="font-semibold">
            ...
            <div>
              ...
              <p className="font-semibold">
                {singlePendingInstituteUser?.information.relation_with_guardian}
              </p>
            </div>
            <div>
              <p className="text-gray-500 uppercase text-xs font-bold">

      ...
      >
        <div className="w-full">
          <div className="hidden md:flex items-center gap-5">
            <img className="w-64 h-12 ms-3 mt-2" src="https://i.ibb.co/8gMntgXX/Gemini-Generated-Image-m517mjm517mjm7.png" />
          </div>
        ...
        <div className="">
          <div className=" flex justify-between shadow-2xl md:pl-16 py-4 md:py-1">
            <div className="flex justify-center items-center text-center print:hidden">
              ...
              <h2 className="text-black font-bold text-lg md:text-3xl p-3 print:hidden">
                Dashboard
              </h2>
            </div>

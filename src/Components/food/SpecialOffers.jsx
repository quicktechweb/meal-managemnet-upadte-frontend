    ...
    <section id="offers" className="pt-8 px-8 bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {offers.map((offer) => (
          <div
            key={offer.id}
            className={`${offer.bgGradient} rounded-3xl p-8 text-white relative overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group`}
          >
            ...
            <div className="relative z-10 w-2/3">
              ...
              <h4 className="text-3xl font-extrabold mb-2 leading-tight">
                {offer.title}
              </h4>
              ...
              <div className="bg-black/20 backdrop-blur-sm border border-white/30 rounded-xl p-3 inline-block">
                ...
                <span className="font-mono font-bold text-lg tracking-widest text-white border-dashed border-b-2 border-white/50">
                  {offer.code}
                </span>
              </div>
            </div>

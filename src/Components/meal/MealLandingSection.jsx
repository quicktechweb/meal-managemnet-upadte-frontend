...
const MealLandingSection = () => {
  return (
    <section id="meal" className="relative py-12 overflow-hidden">
      {/* Background shapes */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 lg:gap-20 items-center">
        {/* LEFT CONTENT */}
...
export default MealLandingSection;
